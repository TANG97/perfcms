...
class ETwigViewRenderer extends CApplicationComponent implements IViewRenderer
{
    ...
    function init()
    {
        ...
        // Adding objects to globals
        $this->_twig->addGlobal('System', new System());
        $this->_twig->addGlobal('Config', System::getSettings());
        $this->_twig->addGlobal('User', new User());
        $this->_twig->addGlobal('UserData', User::$data);
        $this->_twig->addGlobal('App', $app);
        $this->_twig->addGlobal('Lang', new Lang());
        $this->_twig->addGlobal('Filters', new Filters());
        $this->_twig->addGlobal('Ini', new Ini());
        $this->_twig->addGlobal('Settings', User::$settings);
